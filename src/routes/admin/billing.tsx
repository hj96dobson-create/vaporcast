...
const mockCredits = [
  { id: 1, user: "admin@vaporcast.io", balance: "Unlimited", purchased: "Zero cost", used: "N/A" },
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Admin usage is zero cost</p>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Credit balances and usage. Admin accounts are unlimited at zero cost.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
